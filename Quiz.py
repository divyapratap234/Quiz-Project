...
questions={}
h=['divya','simran','aman','aditya']
p=['1105','2606','1505','1102']
s1=input('Enter the Host Name:')
s2=input('Enter the Password:')
quiz=pd.read_csv('C:\\Users\\Simran Prabhakar\\Documents\\Python Quiz Project\\Quiz.csv')
player=pd.read_csv('C:\\Users\\Simran Prabhakar\\Documents\\Python Quiz Project\\Players.csv')
if s1 in h :
    if s2 in p:
        while True:
            sco=0
            ...
            print('                                           _____________                                         ')
            print('\n')
            print('                                Designed by Divya Pratap Singh                                   ')
            print('\n')
            print('\n')
            print('++=============================================================================================++')
            print('||                                       ___               _____                               ||')
            ...
            if o=='a' or o=='A':
                ...
                if o1 not in l1:
                    ...
                    if c=='Y' or c=='y':
                        ...
                        print(player)
                        player.to_csv('C:\\Users\\Simran Prabhakar\\Documents\\Python Quiz Project\\Players.csv',na_rep='NULL',index=False)
                        c=input('Press Enter to Continue')
                ...
                print(player)
                print('\n')
                player.to_csv('C:\\Users\\Simran Prabhakar\\Documents\\Python Quiz Project\\Players.csv',index=False)
                c=input('Press Enter to Continue')
